    ...
    <div className="container grid grid-cols-1 md:grid-cols-2 min-h-[650px]">
        ...
        md:py-0 relative z-10">
            ...
            lg:max-w-[400px]">
                ...
                initial="hidden"
                animate="visible"
                 className="text-2xl tracking-wide text-red-400">Order Now For Fresh Healthy Life
                 </motion.p>  
                 <motion.p 
                 ...
                 className="text-gray-400">
                    Healthy and yummy food for fresh morning breakfast. Eat Daily for good health and mind OrdeR Now and get 20%
